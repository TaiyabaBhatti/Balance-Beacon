...
export default function AppRoutePages() {
  return (
    <Routes>
      ...
      />
      <Route
        path="/grounding-tool-library"
        element={
          <ProtectedRoute>
            <GroundingToolLibrary />
          </ProtectedRoute>
        }
      />
      <Route
        path="/grounding-tool-library/guided-breathing"
        element={
          <ProtectedRoute>
            <GuidedBreathing />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/grounding-tool-library/sensory-exercise"
        element={
          <ProtectedRoute>
            <SensoryExercises />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/system-profiles/add-alter"
        element={
          <ProtectedRoute>
            <CreateAlter />
          </ProtectedRoute>
